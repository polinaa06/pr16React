            ...
            <div className="content">
                ...
                <div className="categories">
                    ...
                    <div className="categories_btn">
                        ...
                        <button onClick={() => setCategory(1)} className="btn">Диваны</button>
                        <button onClick={() => setCategory(2)} className="btn">Шкафы</button>
                        <button onClick={() => setCategory(3)} className="btn">Кровати</button>
                    </div>
                </div>
